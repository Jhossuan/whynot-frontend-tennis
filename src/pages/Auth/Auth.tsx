...
import { SendCodeValidation, ValidateAccount } from '../../api/AuthService';
import { SendCodeI, ValidateAccountI } from '../../types/auth';
                ...
                return (
                    <>
                        ...
                        <Form form={form} onFinish={validateAccount} style={{ margin: '4em 0 0 auto' }} validateMessages={validateMessages}>
                            ...
                            <Form.Item>
                                <Button loading={loading} type="primary" htmlType="submit" style={{ width:'100%', height:'3rem' }}>{ loading ? 'Cargando ...' : 'Verificar cuenta' }</Button>
                            </Form.Item>
                        </Form>
                    </>
                )
